...
ggplot(data = diamonds)+
  geom_point(mapping=aes(x=carat,y=cut,shape=cut,size=price,color=price))
...
ggplot(data = diamonds_sample,mapping = aes(x=carat,y=cut,color=cut))+
  geom_smooth()+
...
ggplot(data = diamonds_sample,mapping = aes(x=cut,y=price,fill=clarity,alpha=0.3,color=cut))+
  geom_smooth()+
  geom_col(mapping = aes(x=cut,y=price,fill=clarity,alpha=0.3))
